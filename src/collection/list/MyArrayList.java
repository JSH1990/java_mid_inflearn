...
public class MyArrayList<E> implements MyList<E> {
    ...
    @Override
    public void add(E e) { //리스트에 데이터 추가. 데이터를 추가하면 size가 하나 증가한다.
        //코드 추가
...
//        }
    ...
    public E get(int index) { //인덱스에 있는 항목을 조회한다.
    ...
    public E set(int index, E element) { //인덱스에 있는 항목을 변경한다.
    ...
    @Override
    public int indexOf(E o) { //검색기능이다. 리스트를 순차탐색해서, 인수와 같은 데이터가 있는 인덱스의 위치를 반환한다. 데이터가 없으면 -1을 반환한다.
